...
STATE_FORMATS = {
    ...
    'DE': r'^[0-9]{2,7}$',
    'DC': r'^[0-9]{7,9}$',
    'FL': r'^[a-zA-Z][0-9]{1,12}$',
    'GA': r'^[0-9]{7,9}$',
    'HI': r'^[0-9]{9}$|^H[0-9]{8}$',
    'ID': r'^[0-9]{9}$|^[a-zA-Z]{2}[0-9]{6}[a-zA-Z]$',
    'IL': r'^[a-zA-Z0-9]{12}$',
    'IN': r'^[a-zA-Z0-9]{10,11}$',
    'IA': r'^[0-9]{9}$|^[0-9]{3}[a-zA-Z]{2}[0-9]{4}$',
    'KS': r'^k[0-9]{8}$|^[0-9]{9}$',
    'KY': r'^[a-zA-Z][0-9]{8}$|^K[0-9]{8}$',
    'LA': r'^[0][0-9]{7}$|^[0][0-9]{8}$|^[0-9]{7}|^[0-9]{8}$',
    'ME': r'^[0-9]{7}$',
    'MD': r'^[a-zA-Z][0-9]{12}$|^[a-zA-Z]{1}[0-9]{12}$',
    'MA': r'^s[0-9]{8}$|^[0-9]{9}$',
    'MI': r'^[a-zA-Z][0-9]{12}$|^[a-zA-Z]{1}[0-9]{12}$',
    'MN': r'^[a-zA-Z][0-9]{12}$|^[a-zA-Z]{1}[0-9]{12}$',
    'MS': r'^[0-9]{9}$',
    'MO': r'^[a-zA-Z][0-9]{5,9}$|^[0-9]{9}$',
    'MT': r'^[0-9]{13}$|^[a-zA-Z][0-9]{9}$',
    'NE': r'^[abceghv][0-9]{3,8}$',
    'NV': r'^[0-9]{10}$|^[0-9]{12}$|^x[0-9]{8}$',
    'NH': r'^[0-9]{2}[a-zA-Z]{3}[0-9]{5}$',
    'NJ': r'^[a-zA-Z][0-9]{14}$',
    'NM': r'^[0-9]{9}$',
    'NY': r'^[a-zA-Z][0-9]{18}$|^[0-9]{9}$',
    'NC': r'^[0-9]{1,12}$',
    ...
    'TX': r'^[0-9]{8}$',
    'UT': r'^[0-9]{4,10}$',
    'VT': r'^[0-9]{8}$|^[0-9]{7}[a-zA-Z]$',
    'VA': r'^[a-zA-Z][0-9]{8}$|^[0-9]{9}$',
